...
p.ord <- plot_ordination(expt.ord, ord, type = "sites", color = "zone_code", shape="zone_code") + geom_point(alpha=0.7,aes(fill=zc_depth)) + theme(aspect.ratio=1) + geom_text(aes(label = month),show.legend = FALSE,size=1,vjust="bottom", nudge_y = -0.1)
...
# individually
pdf(file = "figures/Figure 2.pdf", width=8, height=5)
fig2
dev.off()
...
pdf(file = "figures/Figure 3.pdf", width=5, height=5)
fig3
dev.off()
